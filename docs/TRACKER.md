...
- Last checkpoint: 2026-09-12 post-security-review repair checkpoint.
...
| COORD-1 | CORE-1 | writer A | CAP-LOCAL | one long-lived coordinator owns SQLite; second-owner/restart/gap behavior and loopback API are proved; browser never opens DB | coordinator integration and restart tests | `d2b4a64:e11b258646863627d62eae056fd88344eb8070d2` | DONE_IMPL | NOT_REQUIRED |
| UI-1 | CORE-1 | writer B | CAP-LOCAL | DESIGN Control Room renders real API data or visibly labeled fixtures; accessibility, stale/error/empty/gap/failure states pass browser and visual review | web tests/build, then bounded Playwright/visual checks | `d2b4a64:e11b258646863627d62eae056fd88344eb8070d2` | DONE_IMPL | NOT_REQUIRED |
